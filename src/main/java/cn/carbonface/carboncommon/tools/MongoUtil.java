...
/**
 * classname MongoUtil
 * Description mongodb util for service to use by service self config of mongodb
 *
...
public class MongoUtil {
     ...
     *            集合名
     */
    public static <T> T save(T obj, String collectionName) {
     ...
     * @return
     */
    public static <T> T findOne(Class<T> clazz, String[] findKeys, Object[] findValues) {
        ...
        Query query = Query.query(criteria);
        T resultObj = mongoTemplate.findOne(query, clazz);
        return resultObj;
    }
